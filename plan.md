...
- [ ] infra-015: fix lychee link-check action version so CI resolves
      @area(infra) @owner(context-devops-agent) @status(in-progress) @scenario(2025-11-21T17:01:21Z-lychee)
